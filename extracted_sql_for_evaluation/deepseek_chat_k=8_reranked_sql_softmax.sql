...
SELECT T1.Stadium_ID ,  T1.Location ,  T1.Name ,  (SELECT COUNT(T2.concert_ID) FROM concert AS T2 WHERE T2.Stadium_ID  =  T1.Stadium_ID GROUP BY T2.Stadium_ID) FROM stadium AS T1
...
SELECT T1.concert_Name ,  T1.Theme ,  count(*) FROM concert AS T1 ,  singer_in_concert AS T2 WHERE T1.concert_ID  =  T2.concert_ID GROUP BY T1.concert_ID ,  T1.concert_Name ,  T1.Theme
SELECT Name ,  (SELECT COUNT(concert_ID) FROM singer_in_concert WHERE Singer_ID  =  singer.Singer_ID) FROM singer
...
SELECT ContId ,  Continent ,  count(CountryId) FROM continents ,  countries WHERE continents.Continent  =  countries.Continent GROUP BY ContId ,  continents.Continent
